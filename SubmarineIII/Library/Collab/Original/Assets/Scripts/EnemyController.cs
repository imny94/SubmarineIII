...
public class EnemyController : NetworkBehaviour {
    ...
    void FixedUpdate()
	{			
		foreach (GameObject missile in missiles) {      // This is pretty redundant, missles would be empty as no missles would be initialised at the start of the game
		...
		foreach (GameObject submarine in submarines) { // This might place a load on the network...
